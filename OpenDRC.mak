...
# ---------------------------------------------------------------------------
PROJECT = OpenDRC.exe
OBJFILES = DRC_Main.obj DRC_CmdLine.obj DRC_FileIO.obj DRC_Core.obj Batch_l.obj \
    Batch_y.obj Generic_l.obj
RESFILES = DRC.res
MAINSOURCE = DRC.bpf
RESDEPEN = $(RESFILES)
LIBFILES = 
...
INCLUDEPATH = D:\Dev\Psych499;"C:\Program Files\Borland\CBuilder6\Projects";..\Common;..\html;D:\Dev\Newspaper;$(BCB)\include;$(BCB)\include\vcl
LIBPATH = D:\Dev\Psych499;"c:\program files\borland\cbuilder6\include\vcl";"C:\Program Files\Borland\CBuilder6\Projects";..\Common;..\html;D:\Dev\Newspaper;$(BCB)\lib\obj;$(BCB)\lib
WARNINGS= -w-par
PATHCPP = .;
PATHASM = .;
PATHPAS = .;
...
CFLAG1 = -Od -H=$(BCB)\lib\vcl60.csm -Hc -Vx -Ve -X- -r- -a8 -b- -k -y -v -vi- -tWC \
    -tWM- -c
IDLCFLAGS = -src_suffix cpp -D_DEBUG -ID:\Dev\Psych499 \
    -I"C:\Program Files\Borland\CBuilder6\Projects" -I..\Common -I..\html \
    -ID:\Dev\Newspaper -I$(BCB)\include -I$(BCB)\include\vcl -boa
